...
Partial Public Class masterDataSet
    ...
    Partial Public Class newpatientDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddnewpatientRow(ByVal firstname As String, ByVal middlename As String, ByVal lastname As String, ByVal gender As String, ByVal placeofbirth As String, ByVal age As Long, ByVal contact As Long, ByVal _date As String) As newpatientRow
            Dim rownewpatientRow As newpatientRow = CType(Me.NewRow,newpatientRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, firstname, middlename, lastname, gender, placeofbirth, age, contact, _date}
        ...
        Private Sub InitClass()
            ...
            Me.columnplaceofbirth.AllowDBNull = false
    ...
    Partial Public Class usersDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddusersRow(ByVal FNAME As String, ByVal MNAME As String, ByVal SURNAME As String, ByVal CONTACTS As String, ByVal STATUS As String, ByVal PASSWORD As String) As usersRow
            Dim rowusersRow As usersRow = CType(Me.NewRow,usersRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, FNAME, MNAME, SURNAME, CONTACTS, STATUS, PASSWORD}
        ...
        Private Sub InitClass()
            ...
            Me.columnCONTACTS.AllowDBNull = false
    ...
    Partial Public Class newpatientRow
        ...
        Public Property id() As Long
            Get
                Return CType(Me(Me.tablenewpatient.idColumn),Long)
            End Get
            Set
                Me(Me.tablenewpatient.idColumn) = value
            End Set
        End Property
        ...
        Public Property contact() As Long
            Get
                Try 
                    Return CType(Me(Me.tablenewpatient.contactColumn),Long)
    ...
    Partial Public Class usersRow
        ...
        Public Property CONTACTS() As String
            Get
                Return CType(Me(Me.tableusers.CONTACTSColumn),String)
            End Get
            Set
                Me(Me.tableusers.CONTACTSColumn) = value
            End Set
        End Property
...
Namespace masterDataSetTableAdapters
    ...
    Partial Public Class newpatientTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[newpatient] ([firstname], [middlename], [lastname], [gender], "& _ 
                "[placeofbirth], [age], [contact], [date]) VALUES (@firstname, @middlename, @last"& _ 
                "name, @gender, @placeofbirth, @age, @contact, @date)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Mysystem.My.MySettings.Default.masterConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT id, firstname, middlename, lastname, gender, placeofbirth, age, contact, d"& _ 
                "ate FROM dbo.newpatient"
        ...
        Public Overloads Overridable Function Insert(ByVal firstname As String, ByVal middlename As String, ByVal lastname As String, ByVal gender As String, ByVal placeofbirth As String, ByVal age As Long, ByVal contact As Global.System.Nullable(Of Long), ByVal _date As String) As Integer
            ...
            End If
            Me.Adapter.InsertCommand.Parameters(5).Value = CType(age,Long)
    ...
    Partial Public Class usersTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[users] WHERE (([ID] = @Original_ID) AND ([FNAME] = @Original_F"& _ 
                "NAME) AND ([MNAME] = @Original_MNAME) AND ([SURNAME] = @Original_SURNAME) AND (["& _ 
                "CONTACTS] = @Original_CONTACTS) AND ([STATUS] = @Original_STATUS) AND ([PASSWORD"& _ 
                "] = @Original_PASSWORD))"
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_CONTACTS", Global.System.Data.SqlDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "CONTACTS", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand = New Global.System.Data.SqlClient.SqlCommand
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[users] ([FNAME], [MNAME], [SURNAME], [CONTACTS], [STATUS], [PA"& _ 
                "SSWORD]) VALUES (@FNAME, @MNAME, @SURNAME, @CONTACTS, @STATUS, @PASSWORD);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELE"& _ 
                "CT ID, FNAME, MNAME, SURNAME, CONTACTS, STATUS, PASSWORD FROM users WHERE (ID = "& _ 
                "SCOPE_IDENTITY())"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@CONTACTS", Global.System.Data.SqlDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "CONTACTS", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[users] SET [FNAME] = @FNAME, [MNAME] = @MNAME, [SURNAME] = @SURNAME"& _ 
                ", [CONTACTS] = @CONTACTS, [STATUS] = @STATUS, [PASSWORD] = @PASSWORD WHERE (([ID"& _ 
                "] = @Original_ID) AND ([FNAME] = @Original_FNAME) AND ([MNAME] = @Original_MNAME"& _ 
                ") AND ([SURNAME] = @Original_SURNAME) AND ([CONTACTS] = @Original_CONTACTS) AND "& _ 
                "([STATUS] = @Original_STATUS) AND ([PASSWORD] = @Original_PASSWORD));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT ID"& _ 
                ", FNAME, MNAME, SURNAME, CONTACTS, STATUS, PASSWORD FROM users WHERE (ID = @ID)"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@CONTACTS", Global.System.Data.SqlDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "CONTACTS", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_CONTACTS", Global.System.Data.SqlDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "CONTACTS", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT ID, FNAME, MNAME, SURNAME, CONTACTS, STATUS, PASSWORD FROM dbo.users"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As masterDataSet.usersDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Overridable Function GetData() As masterDataSet.usersDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As masterDataSet.usersDataTable = New masterDataSet.usersDataTable
            Me.Adapter.Fill(dataTable)
            Return dataTable
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As masterDataSet.usersDataTable) As Integer
            Return Me.Adapter.Update(dataTable)
        End Function
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Long, ByVal Original_FNAME As String, ByVal Original_MNAME As String, ByVal Original_SURNAME As String, ByVal Original_CONTACTS As String, ByVal Original_STATUS As String, ByVal Original_PASSWORD As String) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, true)>  _
        Public Overloads Overridable Function Insert(ByVal FNAME As String, ByVal MNAME As String, ByVal SURNAME As String, ByVal CONTACTS As String, ByVal STATUS As String, ByVal PASSWORD As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal FNAME As String, ByVal MNAME As String, ByVal SURNAME As String, ByVal CONTACTS As String, ByVal STATUS As String, ByVal PASSWORD As String, ByVal Original_ID As Long, ByVal Original_FNAME As String, ByVal Original_MNAME As String, ByVal Original_SURNAME As String, ByVal Original_CONTACTS As String, ByVal Original_STATUS As String, ByVal Original_PASSWORD As String, ByVal ID As Long) As Integer
            If (FNAME Is Nothing) Then
                Throw New Global.System.ArgumentNullException("FNAME")
            Else
            ...
            If (Original_MNAME Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_MNAME")
            Else
                Me.Adapter.UpdateCommand.Parameters(8).Value = CType(Original_MNAME,String)
            End If
            If (Original_SURNAME Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_SURNAME")
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal FNAME As String, ByVal MNAME As String, ByVal SURNAME As String, ByVal CONTACTS As String, ByVal STATUS As String, ByVal PASSWORD As String, ByVal Original_ID As Long, ByVal Original_FNAME As String, ByVal Original_MNAME As String, ByVal Original_SURNAME As String, ByVal Original_CONTACTS As String, ByVal Original_STATUS As String, ByVal Original_PASSWORD As String) As Integer
            Return Me.Update(FNAME, MNAME, SURNAME, CONTACTS, STATUS, PASSWORD, Original_ID, Original_FNAME, Original_MNAME, Original_SURNAME, Original_CONTACTS, Original_STATUS, Original_PASSWORD, Original_ID)
        End Function
    End Class
